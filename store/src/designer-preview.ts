...
import { BlockModel, MessageModel, MessagePageModel } from './models';

export class DesignerPreview {
    ...
    constructor(private http: HttpService, private container: HTMLElement) { }
